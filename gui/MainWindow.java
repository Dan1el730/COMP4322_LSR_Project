...
public class MainWindow extends JFrame {
    ...
    private void initComponents() {
        ...
        modifyNetBtn  = styleButton(new JButton("Modify Network"));
        runAllBtn     = styleButton(new JButton("Run Dijkstra (All)"));
        stepModeBtn   = styleButton(new JButton("Step Mode"));
        nextStepBtn   = styleButton(new JButton("Next Step"));
        loadFileBtn   = styleButton(new JButton("Load LSA File"));
    ...
    private void layoutComponents() {
        ...
        getContentPane().setBackground(new Color(10, 16, 22));
        ...
        southPanel.setBackground(new Color(10, 16, 22));
